...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  const syncPointer = (e: React.PointerEvent) => {
    const { clientX: x, clientY: y } = e;

    if (cardRef.current) {
      const rect = cardRef.current.getBoundingClientRect();
      // Local coordinates relative to the card for internal effects
  ...
  const getInlineStyles = () => {
    const baseStyles: any = {
      ...
      // Simplified background attachment for performance in marquees
